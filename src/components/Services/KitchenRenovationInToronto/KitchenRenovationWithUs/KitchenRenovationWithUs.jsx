        ...
        <div>
            <div className='full__section_l_p padding__top'>
                <div className="grid grid-cols-1 md:grid-cols-6 gap-[36px]">
                    ...
                    <div className="md:col-span-3">
                        <div>
                        <Image src="/assets/kitchen_renovation/Kitchen Renovation With Us.png" alt="kitchen renovation with us image" width={770} height={437} className='w-[770px] h-[437px]'/>
                        </div>
                    </div>
                </div>
            </div>
