...
import "./BathroomRenovationsInTorontoBanner.css";

const BathroomRenovationsInTorontoBanner = () => {
  return (
    <>
        ...
        <div className="md:flex items-center relative">
          <div className="w-full md:w-[50%]">
            <div className="py-14 md:py-0 px-4 md:pl-0">
              ...
              Bathroom Renovations <br/> in Toronto
              </h1>
              ...
              Experience top-tier bathroom renovations in Toronto with Fuzion Designs, transforming your space into a stylish oasis of comfort and luxury.
              </p>
          ...
          <div className="hero-right relative hidden md:block">
            <Image
              width={928}
              height={782}
              src="/assets/bathroom_renovation/hero_bg.png"
...
export default BathroomRenovationsInTorontoBanner;
