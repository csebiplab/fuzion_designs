      ...
      <div className="container padding__top">
        <div>
          <div className="mx-auto   flex flex-col items-center justify-center">
            <HeadingIcon text={headingIconText.areas__headingIconText}/>
            ...
            <div>
              ...
              Service Areas of Fuzion Designs in Toronto
              </h3>
            </div>
          </div>
                  ...
                  >
                    <div>
                      <div className="shadow-md p-0 relative">
                        ...
                        <p className="text-base font-bold py-4 px-10 bg-primary text-center lg:text-[18px] absolute bottom-0 left-0 right-0 text-black rounded-b-2xl ">
                          {loc?.location}
                        </p>
                      </div>
                    </div>
