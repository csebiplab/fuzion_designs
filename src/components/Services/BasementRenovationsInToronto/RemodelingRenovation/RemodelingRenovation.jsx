            ...
            <div className='container padding__top'>
                <div className="grid grid-cols-1 md:grid-cols-6 gap-[36px]">
                    ...
                    <div className="order-1 md:col-span-3">
                        <div>
                            <Image src="/assets/basement_renovation/Remodeling & Renovation.png" alt="Remodeling & Renovation image" width={620} height={580} className='w-[620px] h-[311px] md:h-[580px]'/>
                        </div>
                    </div>
                </div>
            </div>
